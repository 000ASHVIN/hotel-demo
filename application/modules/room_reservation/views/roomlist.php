                ...
                <div class="card-header">
                    <div class="content-header row align-items-center g-0">
                        ...
                        <nav aria-label="breadcrumb" class="col-md-12 col-lg-8 col-xl-5 mb-3 d-flex justify-content-center">
                            <div class="mr-2">
                                <input class="form-control datepickers" id="search_date" placeholder="Search Date" type="text" value="" />
                            </div>
                            ...
                            <div class="mr-2">
                                <button type="button" onclick="showResult(null,$('#search_date').val(),$('#search_status').find(':selected').val(),$('#search_apt').find(':selected').val())" class="btn btn-success" id="search">Search</button>
                            </div>
                        </nav>
                        <div class="col-md-12 col-lg-4 mb-3 col-xl-3 header-title">
                            <form class="search" action="#" method="get">
                                <div class="search__inner">
                                    <input type="text" style="padding-left:40px; height:40px" onkeyup="showResult(this.value)" class="search__text" placeholder="Search...">
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3 col-xxl-2 mb-3">
                            <div class="position-relative d-flex justify-content-center">
                                <div class="hotel-image">
                                    <img src="<?php echo base_url((!empty($room_image)) ? $room_image->room_imagename : "assets/img/room-setting/room_images.png"); ?>" class="image-inner" alt="">
                                </div>
                                <div class="scroll-bar overlay-<?php if ($list->status == 2 | $list->status == 4) {
                                                                    echo "green";
                                                                }
                                                                if ($list->status == 1) {
                                                                    echo "black";
                                                                ...
                                                                if ($list->status == 0) {
                                                                    echo "red";
                                                                } ?> px-4 py-3 text-center text-white position-absolute">
                                    <h2 class="fs-21 mt-3 font-weight-bold">
                                        <?php echo display('floor_name') . " ";
                                        echo html_escape($floor->floorname); ?></h2>
                                    <h3 class="fs-21 mt-3 font-weight-bold">
                                        <?php echo display('room_no') . " ";
                                        echo html_escape($list->roomno); ?></h3>
                                    <p class="mb-1">
                                        <?php echo display('room_name') . " :";
                                        echo html_escape($room_type->roomtype); ?></p>
                                    <?php
                                    if ($list->status == 2 | $list->status == 4 | $list->status == 0) {
                                        ...
                                        if (!empty($time->checkoutdate)) {
                                            ...
                                            <p class="mb-1">
                                                ...
                                                echo html_escape(date("Y-m-d", strtotime($time->checkoutdate))); ?>
                                            </p>
                                    ...
                                    <button type="button" class="btn btn-<?php if ($list->status == 2 | $list->status == 4) {
                                                                                echo "primary";
                                                                            }
                                                                            if ($list->status == 1) {
                                                                                echo "success";
                                                                            ...
                                                                            if ($list->status == 0) {
                                                                                echo "warning";
                                                                            } ?> mb-2 font-weight-bold" id="<?php echo empty($id) ? "" : "b_" . $id->bookedid; ?>" value="<?php echo $list->roomno; ?>" data-toggle="modal" onclick="Detail(<?php echo empty($id) ? 0 : $id->bookedid; ?>,<?php echo $list->roomno; ?>)" data-target="#exampleModal1"><?php echo html_escape($status[$list->status]); ?></button>
                                </div>
                            </div>
                        </div>
                        <?php $sl++; ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-green text-white">
                        <h5 class="modal-title font-weight-bold" id="exampleModalLabel"><?php echo display("room_no") ?> : <span id="number"></span> </h5>
                        <button type="button" class="bg-green border-0 fs-23" data-dismiss="modal"><i class="hvr-buzz-out fas fa-times text-white "></i></button>
                    </div>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row mb-3" id="list2">
                                ...
                                <div class="col-12 col-lg-3">
                                    <input type="button" id="bookNow" class="btn btn-success mb-1 mt-2 font-weight-bold" value="Book Now">
                                </div>
                            </div>
                            <div class="row" id="list3">
                                <div class="col-12">
                                    ...
                                    <div class="d-flex mb-2">
                                        <input type="text" class="form-control w-50" id="problem_note" placeholder="Note a problem" value="">

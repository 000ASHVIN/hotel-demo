                    ...
                    <div class="form-card mb-5">
                        <div class="form-card_body">
                            ...
                            <div class="form-group">
                                <label class="input-label font-weight-bold" for="inputEmail"><?php echo display("firstname") ?></label>
                                <input type="text" name="email" autocomplete="off" id="inputEmail"
                                    placeholder="<?php echo display('firstname') ?>" required autofocus

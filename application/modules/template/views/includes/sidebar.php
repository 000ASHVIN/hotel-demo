<div class="sidebar-header">
    <a href="<?php echo base_url('dashboard/home') ?>" class="sidebar-brand">
        <img class="sidebar-brand_icon" src="<?php echo html_escape(base_url((!empty($setting->logo) ? $setting->logo : 'assets/img/sidebar-logo.png'))) ?>" alt="">
    </a>
</div>
<!--/.sidebar header-->
...
<div class="profile-element d-flex align-items-center flex-shrink-0">
    <div class="avatar online">
        <img src="<?php echo html_escape(base_url((!empty($image) ? $image : 'assets/img/user-icon.png'))) ?>" class="img-fluid rounded-circle" alt="">
    </div>
    ...
    <nav class="sidebar-nav">
        <ul class="metismenu">
            ...
            ?>
                    <li class="<?php echo (($this->uri->segment(1) == $moduleName) ? "mm-active" : null) ?>">
                        ...
                        <ul class="nav-second-level <?php echo (($this->uri->segment(1) == $moduleName) ? "mm-show" : null) ?>">
                            ...
                            ?>
                                        <li class="<?php $url = explode('/', $label['url']);
                                            ...
                                            <ul class="mm-collapse<?php echo $ulclass; ?> secondl">
                                                <?php foreach ($label as $name => $value) {
                                                    if ($this->permission->check_label($name)->access()) { ?>
                                                        <li class="<?php $url = explode('/', $value['url']);
                                                                    echo (($this->uri->segment(2) == $url[1]) ? "active" : null) ?>">
            ...
            <?php if ($this->session->userdata('isAdmin')) { ?>
                <li class="<?php echo (($this->uri->segment(1) == "module") ? "mm-active" : null) ?>"><a href="<?php echo base_url('module') ?>"><i class="ti-widgetized"></i><span><?php echo display('moduless') ?></span> </a></li>
                ...
                <li class="<?php echo (($this->uri->segment(1) == "setting") ? "mm-active" : null) ?>"><a href="<?php echo base_url('setting') ?>"><i class="ti-settings"></i><?php echo display('settings') ?></a></li>
            <?php } ?>
        </ul>
    </nav>
</div><!-- sidebar-body -->
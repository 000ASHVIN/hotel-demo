                                    ...
                                    <table width="100%" id="rexdatatable"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo html_escape($book->paid_amount + $book->additional_charges);?></td>
                                                <td><?php echo ($book->total_price-$book->paid_amount)<0 ? 0 : html_escape($book->total_price-$book->paid_amount - $book->additional_charges);?></td>

            ...
            <div class="col-sm-4">
                <ul class="list-unstyled text-right">
                    ...
                    <li>
                        ...
                        <?php 
                        if (!empty($bookinfo->paid_amount)){
                            echo $grprice."\n";
                            echo $totaltax."\n";
                            echo $postedbill."\n";
                            echo $reducetax."\n";
                            echo "=========<br/>";
                            echo $bookinfo->paid_amount."\n";
                            echo $promocode."\n";
                            echo $postedbill."\n";
                            echo $scharge."(".$bookinfo->bookingstatus.")"."\n";
                            $remain_amount = ($grprice+$totaltax+$postedbill+$reducetax)-($bookinfo->paid_amount+$promocode+$postedbill+($bookinfo->bookingstatus==5?$scharge:0));
                            if($remain_amount<0){
                                echo "0";
                            }else{
                                echo $remain_amount;
                            ...
                            echo html_escape($grprice+$totaltax+$scharge+$postedbill);
                         }?>
